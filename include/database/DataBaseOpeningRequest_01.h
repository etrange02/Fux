...
Note:
Il possible qu'il n'y ait pas de localisation pour un titre. Bien que ça puisse paraitre
...
de mes objectifs.
J'hésite sur la présence ou non de certaines informations comme le nom et le nmo de scène
d'un artiste ou encore la position d'un titre dans album.
*/
