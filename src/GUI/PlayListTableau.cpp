...
static wxMutex *s_mutexRechercheEnCours = new wxMutex;
...
{
    wxMutexLocker lock(*s_mutexRechercheEnCours);
...
{
    if (s_mutexRechercheEnCours->TryLock() != wxMUTEX_NO_ERROR)
        return true;
    s_mutexRechercheEnCours->Unlock();
    return false;
}
