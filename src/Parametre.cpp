...
void Parametre::setCheminCouleur(wxString chemin)
{
    ...
    m_cheminCouleur << wxFileName::GetPathSeparator() << _T("Preference") << wxFileName::GetPathSeparator() << _T("Couleur") << wxFileName::GetPathSeparator() << chemin;
}
...
void Parametre::setCheminSon(wxString chemin)
{
    ...
    m_cheminSon << wxFileName::GetPathSeparator() << _T("Preference") << wxFileName::GetPathSeparator() << _T("Son") << wxFileName::GetPathSeparator() << chemin;
}

/**
 * Retourne le chemin complet du fichier contenant les paramètres du graphe
 * @return le chemin
 */
...
/**
 * Retourne le chemin complet du fichier contenant les paramètres du son
 * @return le chemin
 */
